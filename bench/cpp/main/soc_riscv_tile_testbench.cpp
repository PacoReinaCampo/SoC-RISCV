#include "Vsoc_riscv_tile_testbench__Syms.h"
#include "Vsoc_riscv_tile_testbench__Dpi.h"
...
VERILATED_TOPLEVEL(soc_riscv_tile_testbench,clk, rst)

int main(int argc, char *argv[])
{
    soc_riscv_tile_testbench ct("TOP");
